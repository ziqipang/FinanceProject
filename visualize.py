...
def date_occurrence_for_funds(data_dir, fig_dir):
    """
    analyze the monthly occurrence pattern for funds
    :param args: argument
    :return: none
    """
    funds, details, calendar = read_data(data_dir)
    ...
    f.savefig(os.path.join(fig_dir, 'seasonly_occ.pdf'))


def period_length_for_funds(data_dir, fig_dir):
    """
    ...
    f.savefig(os.path.join(fig_dir, 'fund_period_length.pdf'))
...
if __name__ == '__main__':
    ...
    # date_occurrence_for_funds(args.data_dir, args.fig_dir)
    period_length_for_funds(args.data_dir, args.fig_dir)
